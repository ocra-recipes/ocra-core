...
void wOcraExperimentalTrajectory::generateTrajectory()
{
    ...
    wOcraExperimentalTrajectory::generateTrajectory(duration);
}


void wOcraExperimentalTrajectory::generateTrajectory(double _duration)
{
